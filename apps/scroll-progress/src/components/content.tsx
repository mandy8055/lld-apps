  ...
  return (
    <main className='max-w-2xl mx-auto px-4 pt-8 pb-16'>
      ...
      <p className='mb-6 leading-relaxed text-gray-700'>
        ...
        to quietly sleep through that furniture-rattling noise? True, he had not
        slept peacefully, but probably all the more deeply because of that. What
        should he do now?
      </p>

      <p className='mb-6 leading-relaxed text-gray-700'>
        The next train went at seven; if he were to catch that he would have to
        rush like mad and the collection of samples was still not packed, and he
        did not at all feel particularly fresh and lively.
      </p>
      ...
      <p className='mb-6 leading-relaxed text-gray-700'>
        ...
        with no understanding. What about if he reported sick?
      </p>

      <p className='mb-6 leading-relaxed text-gray-700'>
        But that would be extremely strained and suspicious as in fifteen years
        of service Gregor had never once yet been ill. His boss would certainly
        come round with the doctor from the medical insurance company, accuse
        ...
        but that many were workshy.
      </p>

      <p className='mb-6 leading-relaxed text-gray-700'>
        And what's more, would he have been entirely wrong in this case? Gregor
        did in fact, apart from excessive sleepiness after sleeping for so long,
        feel completely well and even felt much hungrier than usual. One
      ...
      <p className='mb-6 leading-relaxed text-gray-700'>
        ...
        into his former position. "Getting up early all the time", he thought,
        "it makes you stupid.
      </p>
      ...
      <p className='mb-6 leading-relaxed text-gray-700'>
        If I didn't have my parents to think about I'd have given in my notice a
